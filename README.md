...
Новый номер получает статус «Ожидается на складе». Ошибочно добавленную запись можно отменить без физического удаления. Приём товара на складе и Cargo ID относятся к следующему этапу и пока не реализованы.
...
services/               бизнес-логика клиентов, трек-номеров и сообщений
