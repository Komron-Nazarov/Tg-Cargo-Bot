...
def demo_card(state: DemoState, rate: Decimal) -> str:
    ...
    pages = (
        ...
        "Продавец дал китайский трек-номер <code>DEMO-LP123456789CN</code>. В реальном боте клиент добавляет настоящий номер в «🔎 Китайские трек-номера». Статус: «Ожидается на складе».",
